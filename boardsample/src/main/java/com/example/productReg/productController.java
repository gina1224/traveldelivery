...
public class productController {
	...
	public ModelAndView read() throws Exception{
		ModelAndView popupPage = new ModelAndView("productReg/read2");
		popupPage.addObject("fromNation",ProductService.findAllfromNations());
		popupPage.addObject("toNation",ProductService.findAlltoNations());
		popupPage.addObject("SIZE",ProductService.findAllSizes());
		popupPage.addObject("WEIGHT",ProductService.findAllWeights());
		return popupPage;
	}
	...
	public ModelAndView update(@RequestParam String PNAME, @RequestParam double PRICE, 
		...
		ModelAndView productPage = new ModelAndView("productReg/update");
